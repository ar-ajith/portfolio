...
function Home() {
  return (
    <motion.div
      className="home page"
      initial={{ opacity: 0, y: 20 }}      // animation on page load
      animate={{ opacity: 1, y: 0 }}        // animation while shown
      exit={{ opacity: 0, y: -20 }}         // animation when leaving
      transition={{ duration: 0.5 }}        // smooth duration
    >
